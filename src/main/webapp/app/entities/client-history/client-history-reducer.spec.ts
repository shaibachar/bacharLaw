...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLIENTHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLIENTHISTORY actions', async () => {
      const arg = { id: 18754 };
    ...
    it('dispatches UPDATE_CLIENTHISTORY actions', async () => {
      const arg = { id: 18754 };
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLIENTHISTORY actions', async () => {
      const arg = 42666;
