...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './fee.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FEE actions', async () => {
      const arg = { id: 3776 };
    ...
    it('dispatches UPDATE_FEE actions', async () => {
      const arg = { id: 3776 };
    ...
    it('dispatches PARTIAL_UPDATE_FEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FEE actions', async () => {
      const arg = 42666;
